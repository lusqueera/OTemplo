...
import { useAuthStore, useConfigStore } from './store/stores';
import ToastContainer from './components/ui/ToastContainer';
import { LoginPage, RegisterPage } from './modules/auth/AuthPages';
import Dashboard from './modules/dashboard/Dashboard';
import PriorityOS from './modules/priority/PriorityOS';
import HabitOS from './modules/habits/HabitOS';
import FocusOS from './modules/focus/FocusOS';
import BrainOS from './modules/brain/BrainOS';
import FinanceOS from './modules/finance/FinanceOS';
import ReviewOS from './modules/review/ReviewOS';
import AnalyticsOS from './modules/analytics/AnalyticsOS';
import TrainingOS from './modules/training/TrainingOS';
import AgendaOS from './modules/agenda/AgendaOS';
import InvestmentsOS from './modules/investments/InvestmentsOS';
import InsightsAI from './modules/insights/InsightsAI';
import NotesOS from './modules/notes/NotesOS';
import SystemConfig from './modules/config/SystemConfig';
import AdminOS from './modules/admin/AdminOS';
